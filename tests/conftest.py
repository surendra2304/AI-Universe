...
def mock_all_provider_api_keys(monkeypatch):
    """Ensure all 10 provider API keys are populated during tests."""
    ...
    monkeypatch.setattr(settings, "CEREBRAS_API_KEY", "mock_cerebras_key_123")
    ...
    monkeypatch.setattr(settings, "TOGETHER_API_KEY", "mock_together_key_123")
    monkeypatch.setattr(settings, "FIREWORKS_API_KEY", "mock_fireworks_key_123")
    monkeypatch.setattr(settings, "DEEPSEEK_API_KEY", "mock_deepseek_key_123")
