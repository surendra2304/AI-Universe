...
Curated test prompts across 6 evaluation vectors:
1. Architecture & System Design
2. Code Generation & Refactoring
3. Bug Analysis & Root Cause Diagnosis
4. Security Threat Modeling
5. Fact Verification & Counter-Argumentation
6. Strategy & Multi-Criteria Decision Analysis
