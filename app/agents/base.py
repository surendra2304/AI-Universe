...
class AgentResponse(BaseModel):
    ...
    code: Optional[str] = Field(default=None, description="Concrete code snippets, schemas, or pseudocode if applicable")
    ...
    dissent: Optional[str] = Field(default=None, description="Identified counterpoints, risks, or dissent from other perspectives")
