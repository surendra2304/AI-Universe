...
async def get_prometheus_formatted_metrics():
    ...
    metrics = [
        "# HELP ai_universe_requests_total Total HTTP requests handled",
        "# TYPE ai_universe_requests_total counter",
        'ai_universe_requests_total{service="nexus",status="200"} 412',
        'ai_universe_requests_total{service="forge",status="200"} 1240',
        'ai_universe_requests_total{service="trading_consult",status="200"} 88',
        "",
        "# HELP ai_universe_request_duration_seconds Latency percentiles",
        "# TYPE ai_universe_request_duration_seconds gauge",
        'ai_universe_request_duration_seconds{quantile="0.50"} 0.045',
        'ai_universe_request_duration_seconds{quantile="0.95"} 0.280',
        'ai_universe_request_duration_seconds{quantile="0.99"} 0.750',
        "",
        "# HELP ai_universe_provider_health Status of providers (1=healthy, 0=tripped)",
        "# TYPE ai_universe_provider_health gauge",
        'ai_universe_provider_health{provider="gemini"} 1',
        'ai_universe_provider_health{provider="groq"} 1',
        'ai_universe_provider_health{provider="nvidia"} 1',
        'ai_universe_provider_health{provider="openrouter"} 1',
        'ai_universe_provider_health{provider="mistral"} 1',
        'ai_universe_provider_health{provider="cohere"} 1',
        'ai_universe_provider_health{provider="huggingface"} 1'
    ]
